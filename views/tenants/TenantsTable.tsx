                ...
                <div className="overflow-x-auto border-t border-gray-100 min-h-[300px]">
                     <table className="min-w-full text-sm text-left">
                        <thead className="text-gray-500 font-normal border-b border-gray-100">
                            <tr>
                                <th className="p-3 w-4"><input type="checkbox" className="rounded border-gray-300 text-[#1a237e] focus:ring-[#1a237e]"/></th>
                                <th 
                        ...
                        <tbody className="text-gray-600">
                            {tenants.map(tenant => (
                                <tr key={tenant.id} className="hover:bg-gray-50 border-b border-gray-50 last:border-0 relative">
                                    ...
                                    <td className="p-3 font-medium text-blue-600 hover:underline cursor-pointer">{tenant.name}</td>
                                        ...
                                        {activeDropdownId === tenant.id && (
                                            <>
                                                ...
                                                <div className="absolute right-0 top-8 w-56 bg-white border border-gray-200 rounded-sm shadow-xl z-20 overflow-hidden">
                                                    ...
                                                    <button className="block w-full text-left px-4 py-2 text-xs text-gray-700 hover:bg-gray-100 hover:text-[#1a237e]">Edit</button>
                                                    <button className="block w-full text-left px-4 py-2 text-xs text-gray-700 hover:bg-gray-100 hover:text-[#1a237e]">View Tenant Transactions</button>
                                                    <button className="block w-full text-left px-4 py-2 text-xs text-gray-700 hover:bg-gray-100 hover:text-[#1a237e]">Add Invoice</button>
                                                    <button className="block w-full text-left px-4 py-2 text-xs text-gray-700 hover:bg-gray-100 hover:text-[#1a237e]">Add Payment</button>
                                                    <button className="block w-full text-left px-4 py-2 text-xs text-gray-700 hover:bg-gray-100 hover:text-[#1a237e]">Send Custom Message</button>
                                                    ...
                                                    <button className="block w-full text-left px-4 py-2 text-xs text-gray-700 hover:bg-gray-100 hover:text-[#1a237e]">Download CSV</button>
                                                    <button className="block w-full text-left px-4 py-2 text-xs text-gray-700 hover:bg-gray-100 hover:text-[#1a237e]">Shift Tenant</button>
                                                    <div className="border-t border-gray-100"></div>
                                                    <button className="block w-full text-left px-4 py-2 text-xs text-gray-700 hover:bg-gray-100 hover:text-[#1a237e]">Delete Tenant</button>
                                                </div>
                                            </>
                                        )}
                                    </td>
